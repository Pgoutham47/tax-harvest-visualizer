...
const InfoModal: React.FC<InfoModalProps> = ({ isOpen }) => {
  ...
  return (
    <div className="bg-[#1e1e2d] py-2 px-4 rounded-b-lg -mt-1 border-t-0 border border-blue-500/30">
      <ul className="space-y-3 list-disc pl-5 py-2 text-sm text-gray-300">
